...
## It takes only a few seconds to read all data into data frame so I didn't do any filtering first using the below command
...
png("plot2.png", width=480, height=480) # open a PNG file device
par(mar=c(2,4,2,4))
plot(data2$DateTime, data2$Global_active_power, type="l", xlab="", ylab="Global Active Poewr(kilowatts)")
